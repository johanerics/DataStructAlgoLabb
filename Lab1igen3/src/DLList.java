...
public class DLList {
    ...
    public void addLast(Point p) {
        ...
        Node newNode = new Node(p, q.size() - 1);
        if (head == null) {
            this.q.add(newNode);
            head = newNode;
            tail = newNode;
        ...
        else
            {
                //if size >=3
                tail.next = newNode;
                tail.imp=importanceOfP(tail.prev.p,tail.p,tail.next.p);
                newNode.prev = tail;
                this.q.add(newNode);
                tail = newNode;
    ...
    public void reduceListToKElements(int k){
        ...
        //int t=5;
            ...
            {
                removedNode.prev.imp=(importanceOfP(removedNode.prev.prev.p,removedNode.prev.p,removedNode.next.p));
                q.remove(removedNode.prev);
                q.add(removedNode.prev);
            }
            if(removedNode.next.next!=null)
            {
                removedNode.next.imp = (importanceOfP(removedNode.prev.p, removedNode.next.p, removedNode.next.next.p));
                q.remove(removedNode.next);
