	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == test) {
			...
			try{ 
				...
				listModel.addElement("Null Pointer Exception troligen från er kod, se stack trace");
				System.out.println("==============================================================");
				System.out.println("==============================================================");
				System.out.println("Null Pointer Exception troligen från er kod, se stack trace");
				System.out.println("text från exeption = " + ex.getMessage());
				System.out.println("==============================================================");
				ex.printStackTrace();
				System.exit(1); // denna rad kan kommenteras bort om man inte vill avbryta
			}
		}
	}
	// ========== ========== ========== ==========
